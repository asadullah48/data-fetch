            ...
            <div className="mt-16">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="bg-[#1b2232] text-white rounded-lg shadow-lg p-6">
                        ...
                        Designing intuitive and aesthetically captivating user interfaces with a sharp focus on enhancing user experience.
                        </p>
                    </div>
                    <div className="bg-[#1b2232] text-white rounded-lg shadow-lg p-6">
                        <h3 className="text-xl font-semibold mb-2">FrontEnd Development</h3>
                        <p className="text-gray-300">
                        Delivering digital, responsive, and highly functional experiences by leveraging cutting-edge web technologies.
                        </p>
                    </div>
                    ...
                    <div className="bg-[#1b2232] text-white rounded-lg shadow-lg p-6">
                        ...
                        <p className="text-gray-300">
                        Expertly managing and updating website content through advanced CMS solutions to maintain relevance and precision.
                        </p>
                    </div>
                </div>
            </div>
