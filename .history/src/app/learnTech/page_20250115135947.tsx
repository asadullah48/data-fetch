    ...
    <div className="h-screen flex items-center justify-center bg-gradient-to-br from-[#0f172a] via-[#1b2232] to-[#1fe951] relative overflow-hidden">
            ...
            <div className="text-center relative z-10">
                ...
                <div className="mt-10">
                    <Link
                        href="/"
                        className="px-6 py-3 text-lg font-bold text-white bg-gradient-to-r from-[#082c11] to-[] rounded-full shadow-white shadow-md transform transition hover:scale-105 hover:shadow-2xl focus:outline-none"
                    >
                        Back Home
                    </Link>
                </div>
