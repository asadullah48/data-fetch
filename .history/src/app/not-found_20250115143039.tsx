...
const NotFound = () => {
    return (
      <div className="h-screen flex flex-col items-center justify-center bg-gradient-to-br from-[#0f172a] via-[#1b2232] to-[#db1546] relative overflow-hidden text-white">
