    ...
    <>
      <div className=" w-screen flex flex-col justify-center items-center mb-20">
        ...
        <div className="flex justify-center items-center gap-10 mt-20 flex-wrap">
          ...
          <h1 className={` text-5xl font-bold relative after:contents-[''] after:absolute after:w-0 after:h-2 after:bg-PrimaryBlue after:-bottom-2 after:left-0 after:transition-all after:duration-300 hover:after:w-full `}>Faster</h1>
