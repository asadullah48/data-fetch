      ...
      <div className='flex justify-center items-center w-full'>
        <div className='my-5 flex flex-col justify-center items-start w-[60%]'>
          ...
          <ul className='list-disc tracking-wide mb-8 text-gray-400 flex flex-col gap-5'>
            <li>Definition: CSR is the process where the browser loads a minimal HTML page with JavaScript and fetches the necessary data or  
                renders necessary logic to render the UI.
            </li>
