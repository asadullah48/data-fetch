  ...
  return (
    ...
    >
      ...
      <p className="text-lg font-normal text-center mb-20 md:w-[60%] text-gray-400 mt-10">
        In Next.js, rendering can be accomplished using either Client-Side Rendering (CSR) or Server-Side Rendering (SSR). CSR loads content on the
        client side after the initial page load, enhancing interactivity and reducing server load, but it can potentially affect SEO. Conversely, SSR generates HTML on the server for each request, improving both SEO and
      ...
      <div className="mt-20 flex justify-center items-center w-full">
        <div className="my-5 flex flex-col justify-center items-start w-[60%]">
          ...
          <ul className="list-disc mb-8 tracking-wide text-gray-400 flex flex-col gap-5">
            <li>
              Definition: SSR is the process where the server renders the full
              HTML for the page on each request, and the browser just receives a
              fully rendered page.
            </li>
