    ...
    return (
        <div className="w-screen h-screen flex items-center justify-center  text-white ">
            ...
            min-[600px]:w-[60%]  bg-black p-5 rounded-2xl">
                ...
                <h1 className="text-5xl text-white font-extrabold mt-10 mb-20">Login</h1>
                <form className="w-full flex flex-col justify-center items-center">
                    ...
                    <div className="w-full flex flex-col justify-center items-center gap-5 mt-10">
                        <button type="submit" className="w-[90%] md:w-[352px] h-[40px] bg-StrongBlue text-white  md:text-lg font-bold rounded-xl">
                            Login
                        </button>

                        <Link href={"/signup"} className="w-[90%] md:w-[352px] ">
                            <button className="w-full  h-[40px] bg-StrongBlue text-white text-sm md:text-lg  rounded-xl">
                                Sign Up
                            </button>
                        </Link>
                    </div>
